...
$app->post("/register", function(){
	...
	$user->setData([
		...
		'nrphone' => (isset($_POST['phone']) && $_POST['phone']) ? $_POST['phone'] : null
	]);
...
$app->post("/profile", function(){
	...
	$_POST['nrphone'] = (isset($_POST['phone']) && $_POST['phone']) ? $_POST['phone'] : null;
...
$path = $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . "res" .
 DIRECTORY_SEPARATOR . "boletophp" . DIRECTORY_SEPARATOR . "include" . DIRECTORY_SEPARATOR; 
